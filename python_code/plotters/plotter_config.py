...
def get_config(plot_type: PlotType) -> Tuple[List[Dict], list, str, str]:
    if plot_type == PlotType.BY_SNR_LONG_CODE:
        params_dicts = [
            ...
            {'snr': 5, 'detector_type': DecoderType.bp.name},
            {'snr': 6, 'detector_type': DecoderType.bp.name},
            {'snr': 7, 'detector_type': DecoderType.bp.name},
            {'snr': 8, 'detector_type': DecoderType.bp.name},
            {'snr': 4, 'detector_type': DecoderType.wbp.name, 'train_blocks_num': 30},
            {'snr': 5, 'detector_type': DecoderType.wbp.name, 'train_blocks_num': 30},
            {'snr': 6, 'detector_type': DecoderType.wbp.name, 'train_blocks_num': 30},
            {'snr': 7, 'detector_type': DecoderType.wbp.name, 'train_blocks_num': 30},
            {'snr': 8, 'detector_type': DecoderType.wbp.name, 'train_blocks_num': 30},
            {'snr': 4, 'detector_type': DecoderType.model_based_bayesian_wbp.name},
            {'snr': 5, 'detector_type': DecoderType.model_based_bayesian_wbp.name},
            {'snr': 6, 'detector_type': DecoderType.model_based_bayesian_wbp.name},
            {'snr': 7, 'detector_type': DecoderType.model_based_bayesian_wbp.name},
